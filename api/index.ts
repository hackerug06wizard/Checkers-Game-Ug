...
app.get('/api/yo/config-status', (req: Request, res: Response) => {
...
app.post('/api/yo/initiate-deposit', async (req: Request, res: Response) => {
  try {
...
app.get('/api/yo/verify-status', async (req: Request, res: Response) => {
  try {
