...
export const CheckersBoard: React.FC<CheckersBoardProps> = ({
  ...
  return (
    <div className="w-full max-w-[680px] max-h-[78vh] aspect-square mx-auto bg-slate-950 p-2 sm:p-3.5 rounded-3xl border-4 border-amber-950/80 shadow-2xl shadow-black/80 flex flex-col justify-between select-none">
      {/* 8x8 Grid Container */}
